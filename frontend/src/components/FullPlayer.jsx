...
<style>{`
  ...
  .ios-volume-input::-webkit-slider-thumb {
    -webkit-appearance: none; width: 20px; height: 20px; background: black; border-radius: 50%; cursor: pointer; opacity: 0.01;
  }
  .ios-volume-input::-moz-range-thumb {
    width: 20px; height: 20px; background: black; border-radius: 50%; border: none; cursor: pointer; opacity: 0.01;
  }
  ...
  .artist-clickable { 
    cursor: pointer; text-decoration: underline; transition: opacity 0.2s ease;
  }
        ...
        <div style={styles.topArea}>
            ...
            <div style={styles.trackInfoWrapper}>
              <div style={{ flex: 1, overflow: 'hidden', paddingRight: '15px' }}>
                ...
                <p 
                  style={styles.artist} className="artist-clickable"
                  onClick={async (e) => {
                    e.stopPropagation();
          ...
          <div style={styles.mainControlsRow}>
            <div style={styles.controlsWrapper}>
              <div className="icon-center" style={styles.sideControlBox}>
                <Shuffle 
                  size="24px" onClick={() => setIsShuffle(!isShuffle)} 
              ...
              <div className="icon-center" style={styles.playControlBox}>
                <div 
                  ...
                  style={styles.playButtonRaw} className="icon-center"
                >
                    {localIsPlaying ? (
              ...
              <div className="icon-center" onClick={toggleRepeat} style={{ 
                ...
                cursor: 'pointer', opacity: repeatMode !== 'none' ? 1 : 0.6 
              }}>
